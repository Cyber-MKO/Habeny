...
export const api = {
  ...
  endMyOtherSessions: () => request("/users/me/sessions/revoke-others", { method: "POST" }),
  getMyTwoFactor: () => request("/users/me/2fa"),
  startTwoFactor: (body) => request("/users/me/2fa/setup", { method: "POST", body }),
