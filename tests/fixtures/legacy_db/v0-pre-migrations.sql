-- Database as created by Habeny's init_db at v0-pre-migrations, with sample rows
BEGIN TRANSACTION;
CREATE TABLE agents (
...
CREATE TABLE sessions (
            ...
            , ip TEXT, user_agent TEXT, last_seen_at TEXT);
...
CREATE TABLE users (
                ...
                created_at TEXT NOT NULL,
                last_login_at TEXT
            , totp_secret TEXT, totp_enabled INTEGER NOT NULL DEFAULT 0, totp_last_step INTEGER, recovery_codes TEXT, oidc_subject TEXT);
INSERT INTO "users" VALUES(1,'olduser','scrypt$x',0,'operator','2025-01-01',NULL,NULL,0,NULL,NULL,NULL);
INSERT INTO "users" VALUES(2,'second','scrypt$y',0,'operator','2025-01-02',NULL,NULL,0,NULL,NULL,NULL);
