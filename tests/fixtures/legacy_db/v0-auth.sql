-- Database as created by Habeny's init_db at v0-auth, with sample rows
BEGIN TRANSACTION;
CREATE TABLE agents (
...
INSERT INTO "users" VALUES(1,'olduser','scrypt$x','2025-01-01',NULL);
INSERT INTO "users" VALUES(2,'second','scrypt$y','2025-01-02',NULL);
